"""
A collection of rewards that are computed based on some common rules.
"""
...
def format_reward(completions, **kwargs):
    ...
    Correct format, reward =1.0; otherwise, reward=0.0.
    """
...
def extract_code(completion: str) -> str:
    """Extract the python code snippet from the completion"""
